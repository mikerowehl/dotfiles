...
require("lazy").setup({
		...
		config = function()
			...
			vim.api.nvim_create_autocmd("LspAttach", {
				...
				callback = function(event)
					...
					map("grh", vim.lsp.buf.hover, "[H]over hints")
	...
	{ -- Highlight, edit, and navigate code
		...
		opts = {
			...
			-- C/C++ grammars hit error-recovery states often on incomplete, mid-edit code
			-- (ambiguous declarators, etc.), which breaks treesitter's indent queries while
			-- typing. Built-in cindent handles that case correctly, so fall back to it.
